...
for (s in 1:100) {
  ...
  Direct_ran_M1 <- Direct(X, T, Y, Xtest, Ytest,Teta, Deta, QuanModel, DenModel,a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_det_M1 <- Direct(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, DenModel,a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_ran_M0 <- Direct(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, DenModel,a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_det_M0 <- Direct(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, DenModel,a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
