...
for (s in 1:100) {
  ...
  Direct_ran_M1 <- Sampling(X, T, Y, Xtest, Ytest,Teta, Deta, QuanModel, a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_det_M1 <- Sampling(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_ran_M0 <- Sampling(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
  ...
  Direct_det_M0 <- Sampling(X, T, Y, Xtest, Ytest, Teta, Deta, QuanModel, a, Pol,quantiles, type, side, alpha, wthigh, wtlow)
