...
PlotData_SDM_CP<- data.frame(CP=c(CP_SDM_H3_Sw,CP_SDM_H3_Dw,CP_SDM_H3_BSw,CP_SDM_H3_BDw,CP_SDM_H4_Sw,CP_SDM_H4_Dw,CP_SDM_H4_BSw,CP_SDM_H4_BDw,CP_SDM_H5_Sw,CP_SDM_H5_Dw,CP_SDM_H5_BSw,CP_SDM_H5_BDw),Methods=c(rep("3-1",100),rep("3-2",100),rep("3-3",100),rep("3-4",100),rep("4-1",100),rep("4-2",100),rep("4-3",100),rep("4-4",100),rep("5-1",100),rep("5-2",100),rep("5-3",100),rep("5-4",100)))
PlotData_SDM_CP$Methods <- factor(PlotData_SDM_CP$Methods,levels=c('3-1','3-2','3-3','3-4','4-1','4-2','4-3','4-4','5-1','5-2','5-3','5-4'),ordered = TRUE)

#Average Length
PlotData_SDM_AL<- data.frame(AL=c(AL_SDM_H3_Sw,AL_SDM_H3_Dw,AL_SDM_H3_BSw,AL_SDM_H3_BDw,AL_SDM_H4_Sw,AL_SDM_H4_Dw,AL_SDM_H4_BSw,AL_SDM_H4_BDw,AL_SDM_H5_Sw,AL_SDM_H5_Dw,AL_SDM_H5_BSw,AL_SDM_H5_BDw),Methods=c(rep("3-1",100),rep("3-2",100),rep("3-3",100),rep("3-4",100),rep("4-1",100),rep("4-2",100),rep("4-3",100),rep("4-4",100),rep("5-1",100),rep("5-2",100),rep("5-3",100),rep("5-4",100)))
PlotData_SDM_AL$Methods <- factor(PlotData_SDM_AL$Methods,levels=c('3-1','3-2','3-3','3-4','4-1','4-2','4-3','4-4','5-1','5-2','5-3','5-4'),ordered = TRUE)
